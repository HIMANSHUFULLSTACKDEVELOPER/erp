...
// Get all today's attendance across all subjects for this teacher
...
$stmt = $conn->prepare($today_attendance_sql);
$stmt->bind_param("iss", $teacher['teacher_id'], $today, $selected_academic_year);
$stmt->execute();
$today_attendance_result = $stmt->get_result();
...
if ($today_attendance_result->num_rows > 0) {
    $today_attendance_result->data_seek(0);
    while($class = $today_attendance_result->fetch_assoc()) {
...
<head>
    ...
    <title>Today's Attendance - College ERP</title>
    ...
    <div class="main-container">
            ...
            <div class="header-content">
                <div class="header-title">
                    ...
                    <div class="header-text">
                        ...
                        <p>View all attendance marked today across your classes</p>
                    </div>
                </div>
                ...
                ?>
                    <div class="class-card">
                        ...
                        <div class="class-actions">
                            <a href="view_class_attendance.php?subject_id=<?php echo $class['subject_id']; ?>&date=<?php echo $today; ?>&academic_year=<?php echo urlencode($selected_academic_year); ?>" class="action-btn view">
                                <i class="fas fa-eye"></i>
                                View Details
                            </a>
                            <a href="mark_attendance.php?subject_id=<?php echo $class['subject_id']; ?>&date=<?php echo $today; ?>&academic_year=<?php echo urlencode($selected_academic_year); ?>" class="action-btn edit">
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <h3 class="empty-title">No Attendance Marked Today</h3>
                <p class="empty-text">You haven't marked attendance for any class yet today.</p>
                <a href="mark_attendance.php" class="empty-action">
